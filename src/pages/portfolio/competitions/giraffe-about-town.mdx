...
crumbs: [ { name: "Home", path: "/" }, { name: "Portfolio", path: "/portfolio" }, { name: "Competitions", path: "/portfolio/competitions" }, { name: "Giraffe About Town", path: "/portfolio/competitions/giraffe-about-town" } ]
